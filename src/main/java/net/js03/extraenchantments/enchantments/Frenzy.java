...
public class Frenzy extends Enchantment {
    public Frenzy(Rarity weight, EnchantmentCategory type, EquipmentSlot[] slotTypes) {
    ...
    protected boolean checkCompatibility(Enchantment pOther) {
        return super.checkCompatibility(pOther) && !(pOther instanceof HealthForBlood);
    }
...
//                if (rng == 0) {
//                    pAttacker.addEffect(new MobEffectInstance(MobEffects.DAMAGE_BOOST, 120, pLevel - 1, false, false, true));
//                    pAttacker.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 120, pLevel - 1, false, false, true));
//                }
//            }
//        }
//    }
